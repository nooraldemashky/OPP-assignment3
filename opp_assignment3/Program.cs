        ...
        case 2:
            {
                ...
                if (title.ToLower().Contains("work") )
                {
                    Console.Write("Enter Company Name: ");
                    string company = Console.ReadLine();

                    task = new WorkTask(title, des, dueDate, company);
                    selectedUser.AddUserTask(task);
                }
                else if (title.ToLower().Contains("study"))
                {
                ...
                else if (title.ToLower().Contains("home"))
                {
        ...
        case 6:
            {
                ...
                {
                    for (int i = 0; i < u.taskApp.Count; i++)
                    {
                        if (u.taskApp[i].Id == task_id)
                        {
                            u.RemoveUserTask(task_id);
                ...
                if (!found)
                {
                    Console.WriteLine("The Incorrect ID");
                }
        ...
        case 7:
            {
                ...
                User selectedUser = users[selectedIndex];
                var active = selectedUser.GetActiveUserTasks();
                if (active.Count == 0)
                {
